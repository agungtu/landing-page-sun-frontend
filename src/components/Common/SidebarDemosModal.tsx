...
const SidebarDemosModal: React.FC = () => {
          ...
          <div className="container-fluid">
            <div className="row justify-content-center">
              ...
              <div className="col-xl-3 col-lg-4 col-sm-6">
                <div className="demo-item">
                  <a href="/home-three/">
                    ...
                    <Image
                      src="/images/demos/home-three.jpg"
                      alt="Demos"
                      width={600}
                      height={700}
                    />
              ...
              <div className="col-xl-3 col-lg-4 col-sm-6">
                <div className="demo-item">
                  <a href="/home-four/">
                    ...
                    <Image
                      src="/images/demos/home-four.jpg"
                      alt="Demos"
                      width={600}
                      height={700}
                    />
              ...
              <div className="col-xl-3 col-lg-4 col-sm-6">
                <div className="demo-item">
                  <a href="/home-five/">
                    ...
                    <Image
                      src="/images/demos/home-five.jpg"
                      alt="Demos"
                      width={600}
                      height={700}
                    />
              ...
              <div className="col-xl-3 col-lg-4 col-sm-6">
                <div className="demo-item">
                  <a href="/home-seven/">
                    ...
                    <Image
                      src="/images/demos/home-seven.jpg"
                      alt="Demos"
                      width={600}
                      height={700}
                    />
              ...
              <div className="col-xl-3 col-lg-4 col-sm-6">
                <div className="demo-item">
                  <a href="/home-eight/">
                    ...
                    <Image
                      src="/images/demos/home-eight.jpg"
                      alt="Demos"
                      width={600}
                      height={700}
                    />
              ...
              <div className="col-xl-3 col-lg-4 col-sm-6">
                <div className="demo-item">
                  <a href="/home-nine/">
                    ...
                    <Image
                      src="/images/demos/home-nine.jpg"
                      alt="Demos"
                      width={600}
                      height={700}
                    />
              ...
              <div className="col-xl-3 col-lg-4 col-sm-6">
                <div className="demo-item">
                  <a href="/home-eleven/">
                    ...
                    <Image
                      src="/images/demos/home-eleven.jpg"
                      alt="Demos"
                      width={600}
                      height={700}
                    />
              ...
              <div className="col-xl-3 col-lg-4 col-sm-6">
                <div className="demo-item">
                  <a href="/home-twelve/">
                    ...
                    <Image
                      src="/images/demos/home-twelve.jpg"
                      alt="Demos"
                      width={600}
                      height={700}
                    />
              ...
              <div className="col-xl-3 col-lg-4 col-sm-6">
                <div className="demo-item">
                  <a href="/home-thirteen/">
                    ...
                    <Image
                      src="/images/demos/home-thirteen.jpg"
                      alt="Demos"
                      width={600}
                      height={700}
                    />
              ...
              <div className="col-xl-3 col-lg-4 col-sm-6">
                <div className="demo-item">
                  <a href="/home-fourteen/">
                    ...
                    <Image
                      src="/images/demos/home-fourteen.jpg"
                      alt="Demos"
                      width={600}
                      height={700}
                    />
              ...
              <div className="col-xl-3 col-lg-4 col-sm-6">
                <div className="demo-item">
                  <a href="/home-sixteen/">
                    <span>App Landing Style - 15</span>
                    <Image
                      src="/images/demos/home-fifteen.jpg"
                      alt="Demos"
                      width={600}
                      height={700}
                    />
              ...
              <div className="col-xl-3 col-lg-4 col-sm-6">
                <div className="demo-item">
                  <a href="/home-sixteen/">
                    ...
                    <Image
                      src="/images/demos/home-sixteen.jpg"
                      alt="Demos"
                      width={600}
                      height={700}
                    />
